            ...
            <div class="card">
                <div class="card-header">
                    <h4>Task Creations and Assignments <a href="{{ route('service-order-task-report') }}"
                            class="btn btn-primary mx-3"><i class="fas fa-eye"></i>
                            View Order Report</a><a href="" class="btn btn-primary mx-3"><i
                                class="fas fa-eye"></i>
                            General Report</a></h4>
                            ...
                            <tbody>
                                ...
                                @forelse ($tasks as $task)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('single-task', ['task_id' => $task->id]) }}"
                                                style="text-decoration: none; cursor:pointer; color:black">{{ $task->name }}</a>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            <div class="progress-text">
                                                {{ $task->status == 'Pending' ? '25%' : '' }}{{ $task->status == 'Approved' ? '50%' : '' }}{{ $task->status == 'Completed' ? '100%' : '' }}
                                            </div>
                                            <div class="progress" data-height="6" style="height: 6px;">
                                                <div class="progress-bar bg-{{ $task->status == 'Pending' ? 'danger' : '' }}{{ $task->status == 'Approved' ? 'warning' : '' }}{{ $task->status == 'Completed' ? 'success' : '' }}"
                                                    data-width="{{ $task->status == 'Pending' ? '25%' : '' }}{{ $task->status == 'Approved' ? '50%' : '' }}{{ $task->status == 'Completed' ? '100%' : '' }}"
                                                    style="width: {{ $task->status == 'Pending' ? '25%' : '' }}{{ $task->status == 'Approved' ? '50%' : '' }}{{ $task->status == 'Completed' ? '100%' : '' }};">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
